...
export 'doctor_appointment_model.dart';
...
class _DoctorAppointmentWidgetState extends State<DoctorAppointmentWidget> {
  late DoctorAppointmentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DoctorAppointmentModel());
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder: (context, doctorIndex) {
                                      ...
                                      return PopularDoctorItemWidget(
                                        key: Key(
                                            'Keysge_${doctorIndex}_of_${doctor.length}'),
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder: (context, hospitalIndex) {
                                      ...
                                      return HospitalItemWidget(
                                        key: Key(
                                            'Keyp9x_${hospitalIndex}_of_${hospital.length}'),
