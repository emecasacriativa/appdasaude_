...
import 'book_ambulance_model.dart';
export 'book_ambulance_model.dart';

class BookAmbulanceWidget extends StatefulWidget {
  const BookAmbulanceWidget({
    super.key,
  ...
  @override
  State<BookAmbulanceWidget> createState() => _BookAmbulanceWidgetState();
}

class _BookAmbulanceWidgetState extends State<BookAmbulanceWidget> {
  late BookAmbulanceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookAmbulanceModel());
