...
import '/my_cart/new_address/new_address_widget.dart';
                            ...
                            children: [
                              ...
                              Builder(
                                builder: (context) {
                                  ...
                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: List.generate(adress.length,
                                        (adressIndex) {
                                      final adressItem = adress[adressIndex];
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          _model.selectedIndex = adressIndex;
                                          safeSetState(() {});
                                        },
                                        child: Container(
