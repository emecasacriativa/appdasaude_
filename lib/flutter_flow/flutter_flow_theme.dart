...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4C5DF4);
  late Color secondary = const Color(0xFFDBDFFD);
  late Color tertiary = const Color(0x33DBDFFD);
  late Color alternate = const Color(0xFFBDC1E1);
  late Color primaryText = const Color(0xFF0C1037);
  late Color secondaryText = const Color(0xFF6E7682);
